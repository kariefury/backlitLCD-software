...
set_property PACKAGE_PIN G13 [get_ports {lcd_tri_io[8]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lcd_tri_io[8]}]
#Bank = 15, Pin name = IO_L20N_T3_A19_15,					Sch name = JA8
set_property PACKAGE_PIN C17 [get_ports {lcd_tri_io[9]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lcd_tri_io[9]}]
#Bank = 15, Pin name = IO_L21N_T3_A17_15,					Sch name = JA9
set_property PACKAGE_PIN D18 [get_ports {lcd_tri_io[10]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lcd_tri_io[10]}]
...
set_property PACKAGE_PIN K2 [get_ports {lcd_tri_io[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lcd_tri_io[0]}]
#Bank = 35, Pin name = IO_L6P_T0_35,						Sch name = JC2
set_property PACKAGE_PIN E7 [get_ports {lcd_tri_io[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lcd_tri_io[1]}]
#Bank = 35, Pin name = IO_L22P_T3_35,						Sch name = JC3
set_property PACKAGE_PIN J3 [get_ports {lcd_tri_io[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lcd_tri_io[2]}]
#Bank = 35, Pin name = IO_L21P_T3_DQS_35,					Sch name = JC4
set_property PACKAGE_PIN J4 [get_ports {lcd_tri_io[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lcd_tri_io[3]}]
#Bank = 35, Pin name = IO_L23N_T3_35,						Sch name = JC7
set_property PACKAGE_PIN K1 [get_ports {lcd_tri_io[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lcd_tri_io[4]}]
#Bank = 35, Pin name = IO_L5P_T0_AD13P_35,					Sch name = JC8
set_property PACKAGE_PIN E6 [get_ports {lcd_tri_io[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lcd_tri_io[5]}]
#Bank = 35, Pin name = IO_L22N_T3_35,						Sch name = JC9
set_property PACKAGE_PIN J2 [get_ports {lcd_tri_io[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lcd_tri_io[6]}]
#Bank = 35, Pin name = IO_L19P_T3_35,						Sch name = JC10
set_property PACKAGE_PIN G6 [get_ports {lcd_tri_io[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lcd_tri_io[7]}]
